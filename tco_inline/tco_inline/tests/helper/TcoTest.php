...
require_once dirname(__DIR__) . '\..\helper\tcoipninline.php';
...
final class TcoTest extends TestCase
{
	...
	public function testIpnResponseValid(){
		$tco_ipn_helper = new TcoIpnInline( $this->params_valid_ipn_mock, $this->order_number, $this->secret_key, $this->current_method );
		$tco_ipn_helper->isIpnResponseValid();
		$this->assertTrue($tco_ipn_helper->isIpnResponseValid());
		$tco_ipn_helper_two = new TcoIpnInline( $this->params_invalid_ipn_mock, $this->order_number, $this->secret_key, $this->current_method );
